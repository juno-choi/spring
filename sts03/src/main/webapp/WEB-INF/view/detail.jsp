   ...
   <div class="row">   
     ...
     <div class="row">
        <div class="col-md-12">
          ...
          <div class="form-group">
             <label for="inputEmail3" class="col-sm-2 control-label">글쓴이</label>
             <div class="col-sm-10">
           ...
           <div class="form-group">
             ...
             <div class="btn-group btn-group-justified" role="group" aria-label="..."> 
                <div class="btn-group" role="group" aria-label="...">
                   <button type="submit" class="btn btn-primary" role="button">입 력</button>
                </div>
                 <div class="btn-group" role="group" aria-label="...">
                  <button type="reset" class="btn btn-default" role="button">취 소</button>
               </div>
            </div>
            </div> 
          </div>
