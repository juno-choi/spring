					...
					<div class="form-group">	
						...
						<div class="col-sm-10">
							<input type="text" class="form-control" id="name"
								placeholder="글쓴이" name="name">
						</div>
						</div>
					<div class="form-group">
						<div class="col-sm-offset-2 col-sm-10">
							<textarea name="content" class="form-control" placeholder="내용을 입력해주세요"></textarea>
						</div>
						
					</div>
					<div class="form-group">
						<div class="col-sm-offset-2 col-sm-5">
							<button type="submit" class="btn btn-default btn-block">입력</button>
						</div>
						<div class="col-sm-5">
